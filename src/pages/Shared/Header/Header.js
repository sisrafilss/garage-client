    ...
    <div className="bg-mintfrost py-3">
      <nav className="container flex justify-between max-sm:relative  text-twilight">
        ...
        <div
          ...
          } flex bg-mintfrost  max-sm:flex-col max-sm:absolute max-sm:top-8 max-sm:right-0  max-sm:h-screen max-sm:px-8 max-sm:w-72 max-sm:space-y-2 max-sm:shadow-left  max-sm:rounded  sm:flex sm:flex-row  sm:space-x-6 md:space-x-12`}
        >
